      ...
      <div className="About-content">
        ...
        <div className="About-paragraph">
          <p>
            ...
            web development, and ability to work as part of a diverse team. My
            diverse background provides me with a unique perspective in tech,
            ...
            insurance sectors to drive digital transformation. In my spare time,
            I continue to expand my tech knowledge. I am currently seeking
            opportunities to apply my development skills in a real-world
            setting, and welcome the chance to connect with like-minded
